...
def process_struc(paths, use_tensors=True):
    ...
    for i, prot_bb in enumerate(pdbs):
        ...
        if use_tensors:
            ...
            X_path = f'/project/bowmanlab/mdward/projects/FAST-DeepPocket-Design-pred/precompute_X/{fn}'
            xyz = np.load(X_path)
        else:
...
def process_paths(apo_IDs, use_tensors=True, use_lm=False):
    ...
    """
    pdb_dir = '/project/bowmanlab/borowsky.jonathan/FAST-cs/DeepPocket-Design-tracking/all-structures/'
    ...
    for i, prot_bb in enumerate(pdbs):
        ...
        if use_lm:
            ...
            S_path = f'/project/bowmanlab/mdward/projects/FAST-DeepPocket-Design-pred/precompute_S/{fn}'
